...
public class PortalLastDelBlock extends Block {
	
	
	public PortalLastDelBlock(String unlocalizedName, Material material, String texturePath) {
		super(material);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int var6, float var7, float var8, float var9) {
		if(!world.isRemote) {
			...
			world.setBlock(x - 3, y + 1, z + 2, Blocks.air);
			world.setBlock(x - 2, y + 1, z + 3, Blocks.air);
			//world.spawnEntityInWorld(new EntityItem(world, x, y, z, new ItemStack(AFRBlocks._PortalBlock)));
